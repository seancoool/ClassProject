    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('cj', '初级'), ('zj', '中级'), ('gj', '高级')], max_length=2, verbose_name='学习难度)')),
                ('category', models.CharField(default='后端开发', max_length=20, verbose_name='课程类别')),
                ('tag', models.CharField(default='', max_length=10, verbose_name='标签')),
                ('cover', models.ImageField(upload_to='courses/%Y/%m', verbose_name='封面')),
                ('need_know', models.CharField(default='', max_length=300, verbose_name='学习须知')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(max_length=200, verbose_name='地址')),
                ('file', models.FileField(max_length=200, upload_to='course/resource/%Y/%m', verbose_name='文件')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程资源',
